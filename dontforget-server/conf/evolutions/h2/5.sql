...
CREATE SEQUENCE T_CATEGORY_seq START WITH nextval('T_TASK_CATEGORY_seq');

DROP SEQUENCE T_TASK_CATEGORY_seq;
...
CREATE SEQUENCE T_TASK_CATEGORY_seq START WITH nextval('T_CATEGORY_seq');
